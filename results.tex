...
\end{figure}
   \end{itemize}
   \section{degaussing studies\label{s:degaussing}}  
   \begin{itemize}
...
\section{Study magnetometer performance with transverse field\label{sec:tilted-results}}  

\begin{figure}
\centering\includegraphics[width=0.5\linewidth]{figures/tilted_field_amp_vs_angle}
\caption{The amplitude of the FID NMOR signals recorded at $2\Omega_L$
  vs. the tilt angle of the magnetic field in
  $xz$-plane.\label{fig:tilted-wrong}}
\end{figure}
...
\begin{figure}
   ...
   \begin{subfigure}[b]{0.45\textwidth}
    ...
    \caption{(a) The amplitude of the FID NMOR signals as a function
      ...
      light-polarization and light propagation vectors(yz-plane). (b)
      FFT of FID NMOR signal in the presence of transverse
      field.\label{fig:something-tilted}}
\end{figure}
