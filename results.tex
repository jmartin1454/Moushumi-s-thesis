...
magnetic shield was degaussed {\bf with what sample rate, etc.?  What
  procedure was followed?}.  While this changed the direction of the
...
Sections~\ref{sec:ch4-transverse} and~\ref{sec:ch5-transverse}) the
...
\begin{figure}
  ...
  \caption{Magnetic field recorded over 3 hours. (a) The stability of
    ...
    shielding. Only a couple pT field drift has observed in this
    case. During this study the signal amplitude was pretty
    low($\sim$)3V} because of the low pump beam power(I think) or ther
  poor settings. As a result the precession width becomes wider(10~pT)
...
drift problem {\bf where is this data?}. During this study {\bf which
...
shield is done which solve the field drift problem {\bf where is this
  data?  Is this (b)?}.
...
two measurement all other setting remain unchanged only the degaussing
of the 2nd innermost shield has performed.
...
\item problem with drift of tune {\bf this will turn out to be a bad
  ...
  \begin{figure}%[h]
    ...
    \caption{Magnetic field recorded over 12~hours.  In this
      ...
      about~120~pT.\label{digilock-drift}}
  \end{figure}
  ...
  optical behavior over longer times {\bf please provide a citation
    for this statement}.
