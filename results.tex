...
vs. temperature has shown in Fig.~\ref{fig:field_vs_temp}. {\bf What
  ...
  synchronized?% For room temperature measurement a precision the Agilent 34410A/11A 6 ½ Digit Multimeter. A python script is used to configures the multimeter for a 2-wire RTD measurement, triggers the meter, and then transfers the reading to the instrument output buffer. .
