...
magnetometer has been operated in FID mode {\bf list all documented
  ...
  %lock-in frequency was 1929.2 Hz and time constant was 300 micro sec.
...
\section{Systematic error check in frequency measurement in FID mode \label{sec:reference-frequency}} 
 ...
 A study has been performed to determine how optimization of the pump and probe beam power effect on precise field measurement.  During this study, the magnetometer has operated in FID mode.  
  \begin{figure}
    \centering
