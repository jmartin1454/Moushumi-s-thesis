...
shielding {\bf where?  Why is it different than room temperature?% I think the reason is that the optics table is fully covered by heavy curtains. I also discussed it with Dave he also mentioned me the same reason.
} is
