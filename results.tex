...
magnetometer has been operated in FID mode 
  lock-in frequency was 1950 Hz and time constant was 300 micro sec. AOM frequency 2049 hz, lock-in time constant 300$\mu$ s. The probe power was $\sim$ 22 $\mu$W and pump power~ 40 $\mu$W
   
 For field measurement the pump and probe time were set to 0.5 sec and 0.5 sec respectively.
...
region-3, the coil current has been reduced to 4.50000 mA {\bf sig figs?}
and measured field for 300 s. After that the coil current has been
decreased by 0.00100 mA. As a result the field also decreased by
50~pT in this region.  Finally in region-5 the coil current has
 been set to 4.50000 mA again and observed the corresponing a change in
field.
