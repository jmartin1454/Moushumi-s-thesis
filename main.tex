...
\begin{abstract}
A non-zero neutron electric dipole moment (nEDM) would indicate
...
nEDM by one order of magnitude ($10^{-27}$~e$\cdot$cm). I developed a
...
serve in an array of such sensors to form an auxiliary magnetometer
...
of the field measurement, drifts over time, impact of degaussing, and
