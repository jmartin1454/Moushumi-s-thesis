...
%trim={<left> <lower> <right> <upper>}
  \includegraphics[width=\textwidth,trim={0cm 4cm 0cm 5cm},clip]{figures/transversefield_2.png}
  \includegraphics[width=\textwidth,trim={0cm 4cm 0cm 5cm},clip]{figures/transversefield}
  \includegraphics[width=\textwidth,trim={0cm 0cm 0cm 10.5cm},clip]{figures/transversefield}
